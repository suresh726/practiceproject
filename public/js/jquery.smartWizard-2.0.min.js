    ...
    a.fn.smartWizard = function(k) {
        ...
        return this.each(function() {
            function z() {
                ...
                n = a("<a>" + c.labelNext + "</a>").attr("href", "#").addClass("buttonNext btn btn-primary");
                o = a("<a>" + c.labelPrevious + "</a>").attr("href", "#").addClass("buttonPrevious btn btn-primary");
            ...
            function r(d, e) {
				...
				//sa(e, b).focus();
				a(e, b).parent().parent().prepend(a(e, b).parent());
