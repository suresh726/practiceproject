...
<section class="content">
	<div class="box box-primary">
		<div class="box-header">
			<h3 class="box-title">Update existing Contact</h3>
		</div><!-- /.box-header -->
		<!-- form start -->
		...
		<div class="box-body">
			<div class="row">
				<div class="col-md-6">
					...
					<div class="form-group">
						...
						<input name = {{$value['column']}} type="text" class="form-control" value="{{$contact[$col_name]}}"/>
			...
			<div class="box-footer">
				...
				<a class="btn btn-warning btn-sm" href="{{ Request::root() }}/contacts">Cancel</a>
			</div>
